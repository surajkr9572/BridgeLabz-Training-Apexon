...
namespace BasicC_Concepts
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //FindAllPairswithaGivenSum findAllPairswithaGivenSum = new FindAllPairswithaGivenSum();
            //findAllPairswithaGivenSum.AllPair(a, target);
            ...
            //int missingresult= missingnumber.missing(a, n);
            //Console.WriteLine("Missing Number is : "+missingresult);
            ...
            //    a[i] = int.Parse(Console.ReadLine());
            //}
            //AllZerostotheEnd allzero=new AllZerostotheEnd();
            //allzero.move(a);
